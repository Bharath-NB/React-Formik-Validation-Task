  ...
  return (
    <div className="book-container">
      ...
      <Formik
        ...
        validate={(values) => {
          const errors = {};
          if (!values.title) errors.title = "Book Title Required";
          if (!values.author) errors.author = "Author Required";
          if (!values.isbn) errors.isbn = "ISBN Number Required";
          if (!values.publicationDate) errors.publicationDate = "Publication Date Required";
          return errors;
        }}
        ...
        {({ isSubmitting }) => (
          <Form className="form">
            <div className="input-field">
              <Field type="text" name="title" placeholder="Enter Title" className="input" />
              <ErrorMessage name="title" component="div" className="error-message" />
            </div>
            <div className="input-field">
              <Field type="text" name="author" placeholder="Enter Author" className="input" />
              <ErrorMessage name="author" component="div" className="error-message" />
            </div>
            <div className="input-field">
              <Field type="text" name="isbn" placeholder="Enter ISBN" className="input" />
