  ...
  return (
    <div className="author-container">
      ...
      <Formik
        ...
        validate={(values) => {
          const errors = {};
          if (!values.name) errors.name = "Please enter the author name";
          if (!values.biography) errors.biography = "Please enter the author biography";
          if (!values.dob) errors.dob = "Date Required";
          return errors;
        }}
        ...
        {({ isSubmitting }) => (
          <Form className="form">
            <div className="input-field">
              <Field type="text" name="name" placeholder="Enter Author's Name" className="input" />
              <ErrorMessage name="name" component="div" className="error-message" />
            </div>
            <div className="input-field">
              <Field type="text" name="biography" placeholder="Enter Author's Biography" className="input" />
              <ErrorMessage name="biography" component="div" className="error-message" />
            </div>
            <div className="input-field">
              <Field type="date" name="dob" placeholder="Enter Author's DOB" className="input" />
